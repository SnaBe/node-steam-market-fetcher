...
import currency from '../resources/ESteamCurrency.js'
import data from '../resources/ESteamDataFormat.js'
 ...
 */
const resizeImage = (image, pixels) => {
 ...
 */
const getImageFromListing = (cdn, market_hash_name, appid, html, size) => {
    // Return the image

...
class SteamMarketFetcher {
     ...
     * @param {Number} start The market listing from which to start the request, optional parameter that defaults to 0 (the first item listed on the market for that app).
